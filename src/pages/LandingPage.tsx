  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
        ...
        <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
            ...
            <button
              ...
              className="group border-2 border-slate-600 hover:border-cyan-400 text-gray-300 hover:text-cyan-400 px-8 py-4 rounded-xl font-semibold text-lg transition-all duration-300 transform hover:scale-105"
            >
      ...
      <section
        id="about"
        ref={aboutRef}
        className={`py-24 bg-slate-900/60 transition-all duration-700 ${aboutInView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-6'}`}
      >
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">{t('about.title') || 'About Civic Dashboard'}</h2>
      ...
      <section
        ref={statsRef}
        className={`bg-slate-900/90 py-12 transition-all duration-700 ${statsInView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-6'}`}
      >
      ...
      <section
        id="features"
        ref={featuresRef}
        className={`py-24 bg-slate-900/50 transition-all duration-700 ${featuresInView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-6'}`}
      >
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {features.map((feature, index) => {
              ...
              return (
                <div
                  key={index}
                  className="group bg-slate-800/50 backdrop-blur-sm rounded-xl p-8 hover:bg-slate-800 transition-all duration-300 transform hover:scale-105 border border-slate-700 hover:border-blue-500/50"
                >
                  <div className="bg-blue-600/10 w-16 h-16 rounded-xl flex items-center justify-center mb-6 group-hover:bg-blue-600/20 transition-colors">
      ...
      <section
        id="how-it-works"
        ref={howRef}
        className={`py-24 bg-slate-900/40 transition-all duration-700 ${howInView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-6'}`}
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="relative">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {/* Step 1 */}
              <div className="relative bg-slate-800/60 rounded-2xl p-10 shadow-md">
                ...
                <div className="mt-6 flex flex-col items-center">
                  <FileText className="w-12 h-12 text-blue-300 mb-6" />
                  <h3 className="text-xl font-semibold text-white mb-3">{t('landing.how.step1') || 'Report Issues'}</h3>
                  <p className="text-gray-400 max-w-md">{t('landing.how.step1Desc') || 'Citizens report civic issues through our platform with location data and photos.'}</p>
                </div>
              </div>
              ...
              <div className="relative bg-slate-800/60 rounded-2xl p-10 shadow-md">
                ...
                <div className="mt-6 flex flex-col items-center">
                  <BarChart3 className="w-12 h-12 text-blue-300 mb-6" />
                  <h3 className="text-xl font-semibold text-white mb-3">{t('landing.how.step2') || 'Track Progress'}</h3>
                  <p className="text-gray-400 max-w-md">{t('landing.how.step2Desc') || 'Staff receive, assign, and track the progress of each reported issue in real time.'}</p>
                </div>
              </div>
              ...
              <div className="relative bg-slate-800/60 rounded-2xl p-10 shadow-md">
                ...
                <div className="mt-6 flex flex-col items-center">
                  ...
                  <h3 className="text-xl font-semibold text-white mb-3">{t('landing.how.step3') || 'Resolve & Update'}</h3>
                  <p className="text-gray-400 max-w-md">{t('landing.how.step3Desc') || 'Issues are resolved efficiently with real-time updates sent to stakeholders.'}</p>
                </div>
              </div>
            </div>
          </div>
